...
Purchases
*/
INSERT INTO PURCHASE (ID, DATE, FINAL_PRICE, OWNER_USER_NAME, USERFA_ID)
 VALUES (HIBERNATE_SEQUENCE.NEXTVAL, SYSDATE,58, 'JMBARGUENO', 2);

 INSERT INTO PURCHASE (ID, DATE, FINAL_PRICE, OWNER_USER_NAME, USERFA_ID)
 VALUES (HIBERNATE_SEQUENCE.NEXTVAL, SYSDATE,585, 'JMBARGUENO', 2);


INSERT INTO PURCHASE (ID, DATE, FINAL_PRICE, OWNER_USER_NAME, USERFA_ID)
 VALUES (HIBERNATE_SEQUENCE.NEXTVAL, TO_DATE('15/06/2019', 'DD/MM/YYYY'),538, 'JMBARGUENO', 2);

 INSERT INTO PURCHASE (ID, DATE, FINAL_PRICE, OWNER_USER_NAME, USERFA_ID)
 VALUES (HIBERNATE_SEQUENCE.NEXTVAL, TO_DATE('22/06/2018', 'DD/MM/YYYY'),258, 'JMBARGUENO', 2);

  INSERT INTO PURCHASE (ID, DATE, FINAL_PRICE, OWNER_USER_NAME, USERFA_ID)
 VALUES (HIBERNATE_SEQUENCE.NEXTVAL, TO_DATE('22/05/2019', 'DD/MM/YYYY'),158, 'JMBARGUENO', 2);
