...
function changePageAndSize() {
    $('#pageSizeSelect').change(function (evt) {
        ...
        var dateFilter = "&dateFilter=" + $('#totalFilter option:selected').val();
        ...
        window.location.replace(urlBase + pageSize + page + strnombre  + dateFilter);
    ...
    $('#totalFilter').change(function () {
        ...
        var urlBase = path;
        // Establece el tamaño de página recién seleccionado
        var pageSize = "?pageSize=" + $('#pageSizeSelect').val();
